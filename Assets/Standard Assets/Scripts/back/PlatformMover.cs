...
public class PlatformMover : MonoBehaviour {
	...
	void Update () {
        Debug.Log("Velocity vector: " + this.BallRigRef.velocity.ToString());
        Debug.Log("Velocity value: " + this.BallRigRef.velocity.magnitude.ToString());
        this.StoppageBugFix();
